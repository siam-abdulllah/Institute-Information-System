...
$query="SELECT * FROM plus_signup,current_address,permanent_address,contact_no,responsibility WHERE plus_signup.id=current_address.id and plus_signup.id=contact_no.id and plus_signup.id=permanent_address.id and plus_signup.id=responsibility.id";
