...
$sql1 = "DELETE FROM plus_signup WHERE id='$id'";
...
echo "";
$sql2 = "DELETE FROM contact_no WHERE id='$id'";
mysql_select_db('test_db');
...
echo "";
$sql3 = "DELETE FROM current_address WHERE id='$id'";
mysql_select_db('test_db');
...
echo "";
$sql4 = "DELETE FROM permanent_address WHERE id='$id'";
mysql_select_db('test_db');
...
echo "";
$sql5 = "DELETE FROM responsibility WHERE id='$id'";
mysql_select_db('test_db');
