...
$query="SELECT * FROM plus_signupst WHERE userid='$userid'";
...
<form id="delete" name="delete" method="post" action="actst.php">
<h3 align='center'><strong><FONT COLOR='#FF6633'>Are you sure to delete this data?</FONT></strong></h3>
<table width="390" border="1" align='center' Bordercolor="CCCCCC" BGcolor="CCCC99">
...
<h3 align='center'><strong><a href="dltfrmst.php">Don't delete this</a></strong></h2>
</table>
